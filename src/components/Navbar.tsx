      ...
      >
        <div className="flex items-center justify-between px-8 py-4">
          ...
          <div className="hidden md:block">
            <Link
              href="/donate"
              className="text-sm font-semibold leading-6 text-white bg-transparent px-6 py-2 rounded-full shadow-lg ring-1 ring-white hover:bg-white/10 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
            >
